...
clean_data_lty$L.Threonine <- as.numeric(as.character(clean_data_lty$L.Threonine))
...
clean_data_lty$L.Cystine <- as.numeric(as.character(clean_data_lty$L.Cystine))
